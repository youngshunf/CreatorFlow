  ...
  return (
    <div className="w-full max-w-[960px] h-full flex flex-col">
      ...
      <div className="mx-auto w-full px-4 pb-4 mt-1" style={{ maxWidth: 'var(--content-max-width, 960px)' }}>
        ...
        {/* Real InputContainer */}
        <InputContainer
          placeholder="Message CreatorFlow..."
          disabled={false}
          isProcessing={false}
          ...
          workingDirectory="/Users/demo/projects/creator-flow"
          sessionId="playground-session"
  ...
  },
  {
    ...
    props: [
      ...
      },
      {
        ...
        defaultValue: 'Message CreatorFlow...',
      },
      {
        name: 'currentModel',
      ...
      },
      {
        ...
        defaultValue: '/Users/demo/projects/creator-flow',
      },
    ],
    mockData: () => {
