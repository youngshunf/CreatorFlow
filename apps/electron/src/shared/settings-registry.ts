...
export const SETTINGS_PAGES = [
  ...
  { id: 'sources', label: 'Sources', description: 'Data sources configuration' },
  { id: 'skills', label: 'Skills', description: 'Manage workspace skills' },
  ...
  { id: 'user-profile', label: 'User Profile', description: 'Your profile settings' },
  { id: 'user-profile-edit', label: 'Edit Profile', description: 'Edit your profile' },
  { id: 'subscription', label: 'Subscription', description: 'Subscription management' },
