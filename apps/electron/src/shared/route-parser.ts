...
export type NavigatorType = 'chats' | 'sources' | 'skills' | 'settings' | 'files' | 'marketplace' | 'video'
...
const COMPOUND_ROUTE_PREFIXES = [
  'home', 'allChats', 'flagged', 'state', 'label', 'view', 'sources', 'skills', 'settings', 'files', 'marketplace', 'video'
]
