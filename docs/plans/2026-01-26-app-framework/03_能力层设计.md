...
**说明**：
- Skills 存储在 `~/.craft-agent/workspaces/{id}/skills/` 或全局 skills 目录
...
```typescript
// 使用现有的 SkillStorage
import { SkillStorage } from '@craft-agent/shared/skills'
...
```typescript
import { CreatorFlowAgent } from '@craft-agent/shared/agent'
