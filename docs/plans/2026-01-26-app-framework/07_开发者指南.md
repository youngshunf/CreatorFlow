...
本指南介绍如何开发 Sprouty AI 应用、插件、Skills 和 Workflows，以及如何发布到市场。
...
```json
{
  ...
  "workspace": {
    ...
    "presetData": {
      ...
      "statuses": [
        { "id": "pending", "name": "待处理", "icon": "circle" },
...
本文档介绍了 Sprouty AI 应用框架的完整开发流程，包括：
...
遵循本指南和最佳实践，你可以开发出高质量的 Sprouty AI 应用并发布到市场。
