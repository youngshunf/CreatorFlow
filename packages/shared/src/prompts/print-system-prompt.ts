...
const systemPrompt = getSystemPrompt(
  ...
  '/Users/example/.creator-flow/workspaces/abc123' // Example workspace path
);
...
const systemPromptWithDebug = getSystemPrompt(
  undefined,
  { enabled: true, logFilePath: '~/Library/Logs/@creator-flow/electron/main.log' },
  '/Users/example/.creator-flow/workspaces/abc123'
);
...
const sessionState = formatSessionState('260121-example-session', {
  plansFolderPath:
    '/Users/example/.creator-flow/workspaces/abc123/sessions/260121-example-session/plans',
});
...
printAnnotation('Generated by CreatorFlowAgent.formatSourceState() - requires agent instance');
...
${colors.bold}Key Files:${colors.reset}
  ...
  packages/shared/src/agent/creator-flow.ts       ${colors.dim}// User message building${colors.reset}
