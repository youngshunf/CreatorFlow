...
const systemPrompt = getSystemPrompt(
  ...
  '/Users/example/.sprouty-ai/workspaces/abc123' // Example workspace path
);
...
const systemPromptWithDebug = getSystemPrompt(
  undefined,
  { enabled: true, logFilePath: '~/Library/Logs/@sprouty-ai/electron/main.log' },
  '/Users/example/.sprouty-ai/workspaces/abc123'
);
...
const sessionState = formatSessionState('260121-example-session', {
  plansFolderPath:
    '/Users/example/.sprouty-ai/workspaces/abc123/sessions/260121-example-session/plans',
});
...
printAnnotation('Generated by SproutyAgent.formatSourceState() - requires agent instance');
