 ...
 *
 * The mapping lives in ~/.creator-flow/tool-icons/tool-icons.json alongside the
 ...
 *
 * @param toolIconsDir - Path to the tool-icons directory (e.g. ~/.creator-flow/tool-icons/)
 ...
 *
 * @param commandStr - Full bash command string, e.g. "git add . && npm publish"
 * @param toolIconsDir - Path to ~/.creator-flow/tool-icons/ containing tool-icons.json and icon files
