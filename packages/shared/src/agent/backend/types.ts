 ...
 * The SproutyAgent facade delegates to these backends, enabling provider switching while
 ...
 * - AsyncGenerator for streaming: Consistent with existing SproutyAgent API
 */
 ...
 * 2. Enable the facade pattern in SproutyAgent
