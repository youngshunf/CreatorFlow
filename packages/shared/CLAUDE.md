...
- Workspace: `~/.creator-flow/workspaces/{id}/permissions.json`
- Source: `~/.creator-flow/workspaces/{id}/sources/{slug}/permissions.json`
...
**Storage:** `~/.creator-flow/workspaces/{id}/statuses/config.json`
...
**Storage:**
- App: `~/.creator-flow/theme.json`
- Workspace: `~/.creator-flow/workspaces/{id}/theme.json`
...
### Sources (`src/sources/`)
Sources are external data connections (MCP servers, APIs, local filesystems). Stored at `~/.creator-flow/workspaces/{id}/sources/{slug}/` with config.json and guide.md. Types: `mcp`, `api`, `local`, `gmail`.
