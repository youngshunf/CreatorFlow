...
Invoke secondary Claude calls for focused subtasks. The tool loads file content automatically from paths you provide.
...
| Deep analysis | sonnet/opus | `thinking: true` |
...
```json
{
  ...
  "content": [{
    "type": "text",
    "text": "Error: Attachment 1: File too large (5000 lines, 250KB, max 2000 lines).\n\nUse a line range to select a portion:\n  { path: \"/logs/app.log\", startLine: 1, endLine: 500 }\n\nFile structure (5000 lines total):\n  Lines 1-1250: imports, config\n  Lines 1251-2500: functions\n  Lines 2501-3750: classes\n  Lines 3751-5000: exports, tests"
  }]
}
```
